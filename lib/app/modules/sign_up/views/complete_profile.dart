                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 94, left: 10),
                                child: Utils.assetImage(AppImages.icon,
                                    height: 55, width: 55),
                              ),
                              SizedBox(
                                height: 8,
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      onFieldSubmitted: (_) {
                                        ...
                                        controller
                                            .selectDatePlatformWise(context);
                                      },
                                    ...
                                    TextInputField(
                                      ...
                                      validator:
                                          controller.isValidDietitianCode,
                                      obscureText: false,
                                      suffixIcon: SizedBox(),
                                      prefixIcon: SizedBox(),
                                      onEditingComplete: () {
